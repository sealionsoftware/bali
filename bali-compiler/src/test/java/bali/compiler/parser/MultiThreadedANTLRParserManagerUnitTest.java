 ...
 * Date: 08/05/13
 */
public class MultiThreadedANTLRParserManagerUnitTest {
	...
	public void testCodeBlock() {
		...
		Assert.assertEquals("For", 1, ((ForStatementNode) ((WhileStatementNode) body.getStatements().get(3)).getBody().getChildren().get(0)).getBody().getChildren().size());
