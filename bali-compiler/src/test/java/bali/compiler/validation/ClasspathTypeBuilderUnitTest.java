...
public class ClasspathTypeBuilderUnitTest {
	...
	private ClasspathTypeBuilder builder = new ClasspathTypeBuilder();
	...
	public void testBuildUnparamterizedType(){
		...
		Assert.assertEquals(Collections.emptyList(), clazz.getInterfaces());
...
//		Assert.assertEquals("aVoidMethodWithArgument", method.getClassName());
...
//		Iterator<TypeReference> expectedParameters = expectation.getArguments().iterator();
//		Iterator<TypeReference> resultParameters = result.getArguments().iterator();
